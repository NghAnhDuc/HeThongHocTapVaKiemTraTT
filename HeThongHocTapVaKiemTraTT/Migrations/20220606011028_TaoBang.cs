        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OralScore = table.Column<double>(type: "float", nullable: false),
                    Score15Minutes = table.Column<double>(type: "float", nullable: false),
                    ScoreCoefficient2 = table.Column<double>(type: "float", nullable: false),
                    ScoreCoefficient3 = table.Column<double>(type: "float", nullable: false),
                    AverageScore = table.Column<double>(type: "float", nullable: false),
                    TotalAverageScore = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scoreboards_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tests_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountClasses", x => new { x.AccountId, x.ClassId });
                    table.ForeignKey(
                        name: "FK_AccountClasses_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountClasses_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountClasses_ClassId",
